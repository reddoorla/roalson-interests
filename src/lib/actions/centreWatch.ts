 ...
 *
 * AND IT REPORTS THROUGH A SCROLL, which is a correction. This action briefly
 * carried a `suspended` option: a pressed pin scrolls its card to the middle,
 * a smooth scroll CROSSES every card between here and there, and the camera
 * was handed a new destination at each one — measured with motion allowed at
 * 1440x900, pressing the IH-35 pin from scrollY 0 sent the page 0 -> 936 and
 * the camera FOUR `flyTo`s in 322ms. Holding this rule back for the length of
